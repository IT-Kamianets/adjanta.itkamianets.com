      ...
      <div class="container mx-auto px-6">
        <div class="flex items-center justify-between relative">
          ...
          <div class="z-10 w-32 md:w-48">
            <a routerLink="/" class="flex items-center group transition-all duration-300">
              <div class="relative">
          ...
          <nav class="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center bg-white/5 border border-white/10 px-8 py-2.5 rounded-full backdrop-blur-md shadow-inner">
            <div class="flex items-center gap-10 text-sm font-semibold tracking-wide">
              <a routerLink="/" fragment="styles" class="text-slate-300 hover:text-fuchsia-400 transition-all duration-300 relative group">
                Стилі
                <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-fuchsia-500 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a routerLink="/" fragment="schedule" class="text-slate-300 hover:text-fuchsia-400 transition-all duration-300 relative group">
                Розклад
                <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-fuchsia-500 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a routerLink="/" fragment="contacts" class="text-slate-300 hover:text-fuchsia-400 transition-all duration-300 relative group">
                Контакти
                <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-fuchsia-500 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a routerLink="/gallery" class="text-slate-300 hover:text-fuchsia-400 transition-all duration-300 relative group">
                Галерея
                <span class="absolute -bottom-1 left-0 w-0 h-0.5 bg-fuchsia-500 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </div>
          ...
          <div class="z-10 w-32 md:w-48 flex justify-end items-center gap-4">
            <a routerLink="/" fragment="contacts" class="hidden md:flex px-6 py-2.5 bg-gradient-to-r from-fuchsia-600 to-purple-600 hover:from-fuchsia-500 hover:to-purple-500 text-white text-sm font-bold rounded-full transition-all duration-300 shadow-lg shadow-fuchsia-600/20 hover:scale-105 active:scale-95 whitespace-nowrap">
              Записатися
            </a>
