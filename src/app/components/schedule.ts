...
@Component({
  ...
  template: `
    <section id="schedule" class="py-20 relative overflow-hidden">
      ...
      <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div
            *ngFor="let dayGroup of schedule; let i = index"
            appReveal="up" [delay]="i * 120"
            class="bg-white/5 border border-white/5 rounded-3xl p-8 backdrop-blur-sm"
          >
            ...
            <div class="space-y-4">
              <div
                *ngFor="let cls of dayGroup.classes"
                class="p-4 rounded-2xl bg-slate-900/50 border border-white/5 hover:border-white/10 transition-colors"
              >
